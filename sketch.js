...
function setup() {
	...
	placeholder1 = new Place(350,620,20,83);
	strokeWeight();
	stroke(0);
	fill("red")

	placeholder2 = new Place(448,620,20,83);
	stroke(0);
	fill("red")

	placeholder3 = new Place(width/2,height-33,80,10);
	stroke(0);
	fill("red")

	var packageBody_options = {restitution:0, isStatic:true}

	dustbin = createSprite(399,617,160,89);
